          ...
          <tr>
            <td style="padding:36px 32px;">
              ...
              <p style="margin:0 0 20px; font-size:15px; line-height:1.6; color:#374151;">
                Tu as demandé à réinitialiser le mot de passe de ton compte Athar. Clique sur le bouton
                ci-dessous pour choisir un nouveau mot de passe. Ce lien expire dans 60 minutes.
              </p>
              ...
              <p style="margin:0; font-size:13px; line-height:1.6; color:#6b7280;">
                Si tu n'es pas à l'origine de cette demande, tu peux ignorer cet email — ton mot de passe
